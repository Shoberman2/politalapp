        ...
        <div className="bill-main">
          ...
          <article className="bill-ai-card">
            <div className="bill-ai-label">
              ...
              <InfoTip text="This plain-English explanation is generated from the bill's official summary and title, then shown with source context.">The bill, in plain English</InfoTip>
            </div>
